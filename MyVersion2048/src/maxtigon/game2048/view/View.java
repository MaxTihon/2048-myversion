package maxtigon.game2048.view;

import maxtigon.game2048.controller.Controller;
import maxtigon.game2048.model.Tile;
...
public class View extends JPanel {
    ...
    public void paint(Graphics g) {
        ...
        g.drawString("Score: " + controller.getScore(), 140, 475);

        if (isGameWon) {
            JOptionPane.showMessageDialog(this, "Congrats! You've won!");
        } else if (isGameLost) {
